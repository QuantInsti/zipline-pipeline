...
from zipline_pipeline.errors import UnsupportedDataType
from zipline_pipeline.lib.labelarray import LabelArray
from zipline_pipeline.lib.quantiles import quantiles
...
from zipline_pipeline.pipeline.term import ComputableTerm
from zipline_pipeline.utils.compat import unicode
from zipline_pipeline.utils.input_validation import expect_types, expect_dtypes
...
class Classifier(RestrictedDTypeMixin, ComputableTerm):
    ...
    def to_workspace_value(self, result, assets):
        ...
        This is the inverse of :func:`~zipline_pipeline.pipeline.term.Term.postprocess`.
        """
        if self.dtype == int64_dtype:
...
class Relabel(SingleInputMixin, Classifier):
    ...
    Parameters
    ----------
    arg : zipline_pipeline.pipeline.Classifier
...
class CustomClassifier(PositiveWindowLengthMixin,
    ...
    zipline_pipeline.pipeline.CustomFilter
    """
    def _validate(self):
        try:
...
class Latest(LatestMixin, CustomClassifier):
    ...
    See Also
    --------
    zipline_pipeline.pipeline.data.dataset.BoundColumn.latest
    """
    pass
