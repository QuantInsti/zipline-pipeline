...
"""
from zipline_pipeline.utils.numpy_utils import float64_dtype, categorical_dtype
...
class EquityPricing(DataSet):
    """
    :class:`~zipline_pipeline.pipeline.data.DataSet` containing daily trading prices and
    volumes.
    """
