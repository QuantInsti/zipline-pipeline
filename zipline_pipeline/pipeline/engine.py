...
1. Determine the domain of the pipeline. The domain determines the
   ...
   zipline_pipeline.pipeline.domain.infer_domain.
...
2. Build a dependency graph of all terms in `pipeline`, with
   ...
   zipline_pipeline.pipeline.graph.TermGraph and
   zipline_pipeline.pipeline.graph.ExecutionPlan.
...
from zipline_pipeline.lib.adjusted_array import ensure_adjusted_array, ensure_ndarray
from zipline_pipeline.errors import NoFurtherDataError
...
from zipline_pipeline.utils.pandas_utils import explode
