...
from zipline_pipeline.utils.compat import wraps
from zipline_pipeline.errors import (
    BadPercentileBounds,
    UnknownRankMethod,
    UnsupportedDataType,
)
from zipline_pipeline.lib.normalize import naive_grouped_rowwise_apply
from zipline_pipeline.lib.rank import masked_rankdata_2d, rankdata_1d_descending
from zipline_pipeline.pipeline.api_utils import restrict_to_dtype
from zipline_pipeline.pipeline.classifiers import Classifier, Everything, Quantiles
from zipline_pipeline.pipeline.dtypes import (
    CLASSIFIER_DTYPES,
    FACTOR_DTYPES,
    FILTER_DTYPES,
)
from zipline_pipeline.pipeline.expression import (
    BadBinaryOperator,
    COMPARISONS,
    is_comparison,
    MATH_BINOPS,
...
from zipline_pipeline.pipeline.filters import (
    Filter,
    NumExprFilter,
    PercentileFilter,
    MaximumFilter,
)
from zipline_pipeline.pipeline.mixins import (
    CustomTermMixin,
    LatestMixin,
...
from zipline_pipeline.pipeline.sentinels import NotSpecified, NotSpecifiedType
from zipline_pipeline.pipeline.term import AssetExists, ComputableTerm, Term
from zipline_pipeline.utils.functional import with_doc, with_name
from zipline_pipeline.utils.input_validation import expect_types
from zipline_pipeline.utils.math_utils import (
    nanmax,
    nanmean,
    nanmedian,
    nanmin,
...
from zipline_pipeline.utils.numpy_utils import (
    as_column,
    bool_dtype,
    coerce_to_dtype,
    float64_dtype,
...
from zipline_pipeline.utils.sharedoc import templated_docstring
...
Construct a :class:`~zipline_pipeline.pipeline.{rtype}` computing ``self {op} other``.

Parameters
----------
other : zipline_pipeline.pipeline.Factor, float
...
BINOP_RETURN_FILTER = """\
filter : zipline_pipeline.pipeline.Filter
    Filter computing ``self {op} other`` with the outputs of ``self`` and
    ``other``.
"""

BINOP_RETURN_FACTOR = """\
factor : zipline_pipeline.pipeline.Factor
...
CORRELATION_METHOD_NOTE = dedent(
    ...
    as inputs to windowed :class:`~zipline_pipeline.pipeline.Factor` objects. Examples
    of such expressions include This includes
    :class:`~zipline_pipeline.pipeline.data.BoundColumn`
    :class:`~zipline_pipeline.pipeline.factors.Returns` and any factors created from
    :meth:`~zipline_pipeline.pipeline.Factor.rank` or
    :meth:`~zipline_pipeline.pipeline.Factor.zscore`.
    """
)
...
def summary_method(name):
    ...
    def f(self, mask=NotSpecified):
        ...
        Parameters
        ----------
        mask : zipline_pipeline.pipeline.Filter, optional
        ...
        Returns
        -------
        result : zipline_pipeline.pipeline.Factor
        """
        return DailySummary(
            func,
            self,
...
class Factor(RestrictedDTypeMixin, ComputableTerm):
    ...
    Factors can also be converted into :class:`zipline_pipeline.pipeline.Filter` objects
    ...
    def demean(self, mask=NotSpecified, groupby=NotSpecified):
        ...
        groupby : zipline_pipeline.pipeline.Classifier, optional
    ...
    def zscore(self, mask=NotSpecified, groupby=NotSpecified):
        ...
        Returns
        -------
        zscored : zipline_pipeline.pipeline.Factor
        ...
        Examples
        --------
        See :meth:`~zipline_pipeline.pipeline.Factor.demean` for an in-depth
    ...
    def rank(self,
        ...
        Returns
        -------
        ranks : zipline_pipeline.pipeline.Factor
    ...
    def pearsonr(self, target, correlation_length, mask=NotSpecified):
        ...
        Parameters
        ----------
        target : zipline_pipeline.pipeline.Term
        ...
        Returns
        -------
        correlations : zipline_pipeline.pipeline.Factor
        ...
        :class:`zipline_pipeline.pipeline.factors.RollingPearsonOfReturns`
    ...
    def linear_regression(self, target, regression_length, mask=NotSpecified):
        ...
        Returns
        -------
        regressions : zipline_pipeline.pipeline.Factor
    ...
    def winsorize(self,
        ...
        Returns
        -------
        winsorized : zipline_pipeline.pipeline.Factor
    ...
    def quantiles(self, bins, mask=NotSpecified):
        ...
        Returns
        -------
        quantiles : zipline_pipeline.pipeline.Classifier
    ...
    def quartiles(self, mask=NotSpecified):
        ...
        Returns
        -------
        quartiles : zipline_pipeline.pipeline.Classifier
    ...
    def quintiles(self, mask=NotSpecified):
        ...
        Returns
        -------
        quintiles : zipline_pipeline.pipeline.Classifier
    ...
    def deciles(self, mask=NotSpecified):
        ...
        Returns
        -------
        deciles : zipline_pipeline.pipeline.Classifier
    ...
    def percentile_between(self,
        ...
        Returns
        -------
        out : zipline_pipeline.pipeline.Filter
    ...
    def isnan(self):
        ...
        Returns
        -------
        nanfilter : zipline_pipeline.pipeline.Filter
        """
        return self != self
...
class GroupedRowTransform(Factor):
    ...
    mask : zipline_pipeline.pipeline.Filter
        Mask of entries to ignore when calculating transforms.
    groupby : zipline_pipeline.pipeline.Classifier
    ...
    See Also
    --------
    zipline_pipeline.pipeline.Factor.zscore
    zipline_pipeline.pipeline.Factor.demean
    zipline_pipeline.pipeline.Factor.rank
    """
    window_length = 0
