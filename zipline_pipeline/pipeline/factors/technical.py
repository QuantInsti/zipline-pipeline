...
from zipline_pipeline.pipeline.mixins import SingleInputMixin
from zipline_pipeline.utils.input_validation import expect_bounded
...
from zipline_pipeline.utils.numpy_utils import rolling_window
...
class RSI(SingleInputMixin, CustomFactor):
    ...
    **Default Inputs**: :data:`zipline_pipeline.pipeline.data.EquityPricing.close`
...
class Aroon(CustomFactor):
    ...
    **Defaults Inputs:** :data:`zipline_pipeline.pipeline.data.EquityPricing.low`, \
                         :data:`zipline_pipeline.pipeline.data.EquityPricing.high`
...
class FastStochasticOscillator(CustomFactor):
    ...
    **Default Inputs:** :data:`zipline_pipeline.pipeline.data.EquityPricing.close`, \
                        :data:`zipline_pipeline.pipeline.data.EquityPricing.low`, \
                        :data:`zipline_pipeline.pipeline.data.EquityPricing.high`
...
class IchimokuKinkoHyo(CustomFactor):
    ...
    **Default Inputs:** :data:`zipline_pipeline.pipeline.data.EquityPricing.high`, \
                        :data:`zipline_pipeline.pipeline.data.EquityPricing.low`, \
                        :data:`zipline_pipeline.pipeline.data.EquityPricing.close`
