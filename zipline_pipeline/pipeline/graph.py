...
from zipline_pipeline.utils.memoize import lazyval
from zipline_pipeline.pipeline.visualize import display_graph
...
class TermGraph(object):
    ...
    def _decref_dependencies_recursive(self, term, refcounts, garbage):
        ...
        should use:
        :meth:`~zipline_pipeline.pipeline.graph.TermGraph.decref_dependencies`
        """
...
class ExecutionPlan(TermGraph):
    ...
    def offset(self):
        ...
        See Also
        --------
        :meth:`zipline_pipeline.pipeline.graph.ExecutionPlan.offset`
        :meth:`zipline_pipeline.pipeline.engine.ExecutionPlan.mask_and_dates_for_term`
        :meth:`zipline_pipeline.pipeline.engine.SimplePipelineEngine._inputs_for_term`
        """
    ...
    def extra_rows(self):
        ...
        **as an input**.  This is not to be confused with `term.dependencies`,
        ...
        --------
        :meth:`zipline_pipeline.pipeline.graph.ExecutionPlan.offset`
        :meth:`zipline_pipeline.pipeline.Term.dependencies`
        """
        return {
