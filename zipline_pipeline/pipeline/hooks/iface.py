from zipline_pipeline.utils.compat import contextmanager as _contextmanager
...
class PipelineHooks(Interface):
    ...
    def computing_chunk(self, terms, start_date, end_date):
        ...
        Parameters
        ----------
        terms : list[zipline_pipeline.pipeline.Term]
    ...
    def loading_terms(self, terms):
        ...
        Parameters
        ----------
        terms : list[zipline_pipeline.pipeline.LoadableTerm]
            Terms being loaded.
        """
    ...
    def computing_term(self, term):
        ...
        Parameters
        ----------
        terms : zipline_pipeline.pipeline.ComputableTerm
