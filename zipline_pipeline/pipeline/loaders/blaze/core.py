...
This module (zipline_pipeline.pipeline.loaders.blaze) exports a function called
...
from zipline_pipeline.pipeline.common import (
    AD_FIELD_NAME,
    SID_FIELD_NAME,
    TS_FIELD_NAME
)
from zipline_pipeline.pipeline.data.dataset import DataSet, Column
from zipline_pipeline.pipeline.domain import GENERIC
from zipline_pipeline.pipeline.loaders.base import PipelineLoader
...
from zipline_pipeline.utils.input_validation import expect_element
from zipline_pipeline.utils.pandas_utils import ignore_pandas_nan_categorical_warning
from zipline_pipeline.utils.pool import SequentialPool
try:
    ...
    def barf(*args, **kwargs):
        raise RuntimeError(
            "zipline_pipeline.pipeline.loaders.blaze._core failed to import"
        )
...
class BlazeLoader(implements(PipelineLoader)):
    ...
    See Also
    --------
    :class:`zipline_pipeline.utils.pool.SequentialPool`
    ...
    def register_dataset(self,
        ...
        See Also
        --------
        :func:`zipline_pipeline.pipeline.loaders.blaze.from_blaze`
        """
        expr_data = ExprData(
            expr,
            deltas,
