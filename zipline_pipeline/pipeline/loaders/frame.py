...
from zipline_pipeline.lib.adjustment import make_adjustment_from_labels
from zipline_pipeline.utils.numpy_utils import as_column
...
class DataFrameLoader(implements(PipelineLoader)):
    ...
    adjustments : pandas.DataFrame, default=None
        A DataFrame with the following columns:
            sid : int
            value : any
            kind : int (zipline_pipeline.pipeline.loaders.frame.ADJUSTMENT_TYPES)
