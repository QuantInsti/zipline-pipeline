...
from zipline_pipeline.errors import UnsupportedPipelineOutput
...
class Pipeline(object):
    ...
    :class:`~zipline_pipeline.pipeline.Term` instances, and 'screen', a
    :class:`~zipline_pipeline.pipeline.Filter` representing criteria for
    ...
    columns : dict, optional
        Initial columns.
    screen : zipline_pipeline.pipeline.Filter, optional
        Initial screen.
    """
    ...
    def columns(self):
        ...
        Returns
        -------
        columns : dict[str, zipline_pipeline.pipeline.ComputableTerm]
    ...
    def screen(self):
        ...
        Returns
        -------
        screen : zipline_pipeline.pipeline.Filter or None
    ...
    def add(self, term, name, overwrite=False):
        ...
        Parameters
        ----------
        column : zipline_pipeline.pipeline.Term
    ...
    def remove(self, name):
        ...
        Returns
        -------
        removed : zipline_pipeline.pipeline.Term
            The removed term.
        """
    ...
    def to_execution_plan(self,
        ...
        default_screen : zipline_pipeline.pipeline.Term
    ...
    def to_simple_graph(self, default_screen):
        ...
        Returns
        -------
        graph : zipline_pipeline.pipeline.graph.TermGraph
    ...
    def domain(self, default):
        ...
        Parameters
        ----------
        default : zipline_pipeline.pipeline.domain.Domain
