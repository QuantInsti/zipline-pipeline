...
from zipline_pipeline.lib.adjusted_array import can_represent_dtype
from zipline_pipeline.lib.labelarray import LabelArray
from zipline_pipeline.utils.input_validation import expect_types
from zipline_pipeline.utils.memoize import classlazyval, lazyval
...
from zipline_pipeline.utils.sharedoc import (
    templated_docstring,
...
class Term(with_metaclass(ABCMeta, object)):
    ...
    :class:`zipline_pipeline.pipeline.Pipeline`.
    ...
    - :class:`~zipline_pipeline.pipeline.Factor`
    - :class:`~zipline_pipeline.pipeline.Filter`
    - :class:`~zipline_pipeline.pipeline.Classifier`
    ...
    **Example:**
    ...
    >>> from zipline_pipeline.pipeline.factors import SimpleMovingAverage
    ...
    def mask(self):
        """
        A :class:`~zipline_pipeline.pipeline.Filter` representing asset/date pairs to
...
class AssetExists(Term):
    ...
    See Also
    --------
    zipline_pipeline.assets.AssetFinder.lifetimes
    """
    dtype = bool_dtype
    dataset = None
    inputs = ()
...
class LoadableTerm(Term):
    ...
    This is the base class for :class:`zipline_pipeline.pipeline.data.BoundColumn`.
    """
    windowed = False
    inputs = ()
...
class ComputableTerm(Term):
    ...
    This is the base class for :class:`zipline_pipeline.pipeline.Factor`,
    :class:`zipline_pipeline.pipeline.Filter`, and :class:`zipline_pipeline.pipeline.Classifier`.
    """
    inputs = NotSpecified
    ...
    def fillna(self, fill_value):
        ...
        Parameters
        ----------
        fill_value : zipline_pipeline.pipeline.ComputableTerm, or object.
        ...
        **Filling with a Term:**
        ...
        Returns
        -------
        filled : zipline_pipeline.pipeline.ComputableTerm
