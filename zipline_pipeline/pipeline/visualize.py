...
from zipline_pipeline.pipeline.data import BoundColumn
from zipline_pipeline.pipeline import Filter, Factor, Classifier, Term
...
def _render(g, out, format_, include_asset_exists=False):
    ...
    Parameters
    ----------
    g : zipline_pipeline.pipeline.graph.TermGraph
        Graph to render.
