...
class ApplyAsyncResult(object):
    ...
    :meth:`~zipline_pipeline.utils.pool.SequentialPool.apply_async`.
    ...
    def ready(self):
        ...
        Notes
        -----
        In the :class:`~zipline_pipeline.utils.pool.SequentialPool` case, this is always
        ``True``.
        """
        return True
    ...
    def wait(self):
        ...
        Notes
        -----
        In the :class:`~zipline_pipeline.utils.pool.SequentialPool` case, this is a nop
        because the function is computed eagerly in the same thread as the
        call to :meth:`~zipline_pipeline.utils.pool.SequentialPool.apply_async`.
        """
        pass
